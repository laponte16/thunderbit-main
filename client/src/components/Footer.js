...
function Footer() {
    return(
        <footer className='fondo-blue'>
            <div className='flex flex-row w-full justify-start texto-white'>
                <p>ThunderBit Kiss kiss muah muah</p>
            </div>

            <div className='flex flex-row w-full justify-end texto-white'>
                <div className='p-2'>
